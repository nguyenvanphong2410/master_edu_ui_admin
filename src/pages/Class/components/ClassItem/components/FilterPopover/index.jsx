...
function FilterPopover({handleChangeTableClass}) {
  const {sort_order, column} = useSelector((state) => state.class.dataFilter);
  ...
  const onChange = (e) => {
    ...
    handleChangeTableClass(null, null, sorter)
  };
          ...
          <div className={`label-wrap label-filter`}>
            ...
            >
              <Space direction="vertical">
                ...
                <Radio value={'sale_price-desc'}>Giá cao - thấp</Radio>
                <Radio value={'sale_price-asc'}>Giá thấp - cao</Radio>
